...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Simulated 3000 frames × 20 particles × 3D in 1.5s
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    SFI/inference/parametric_core/solve.py:240: RuntimeWarning: inner='lbfgs' is unavailable for underdamped solves on the exact core (the frozen-precision objective is unbounded along the damping direction); using the damped Gauss-Newton path.
      res = solver(_as_x64_collection(collection), *args, **kwargs)
    [L-BFGS] inferred in 140.4s
      Force Coefficient Table
      ──────────────────────────────────────
      #    Label   Coefficient  Sig
      ──────────────────────────────────────
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
      ...
      GN   k_coh: inferred=0.0525  rel_error=5.009e-02
      GN   k_alg: inferred=0.2086  rel_error=4.286e-02
      Loss k_coh: inferred=0.05054  rel_error=1.075e-02
      Loss k_alg: inferred=0.2011  rel_error=5.703e-03
      Loss vs GN    : ‖Δθ‖/‖θ‖ = 3.574e-02  (parity gate)
...
.. image-sg:: /gallery/advanced/images/sphx_glr_flocking_3d_demo_003.png
   :alt: Force-field agreement on held-out samples, $r=0.99996$ MSE=0.001, GN, $r=0.99998$ MSE=0.0, L-BFGS
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (4 minutes 49.879 seconds)


.. rst-class:: sphx-glr-example-tags

   🏷 Tags: synthetic, underdamped, multi-particle, solver-comparison
