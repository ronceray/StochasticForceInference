...
.. GENERATED FROM PYTHON SOURCE LINES 95-142
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Normalized MSE (diffusion): 0.0075
      ...
      ────────────────────────────────────────────────────────
      0    <lambda>(∂ₓ(x0))         -6.31071e-01  ·  
      1    <lambda>(∂ₓ(x1))         -8.63615e-01  ·  
      2    <lambda>(∂ₓ(x0^2))       -3.37529e-01  ·  
      3    <lambda>(∂ₓ(x0·x1))       8.92771e-01  ·  
      4    <lambda>(∂ₓ(x1^2))        1.68156e+00  ·  
      5    <lambda>(∂ₓ(x0^3))        4.11307e-01  ·  
      6    <lambda>(∂ₓ(x0^2·x1))     1.13218e+00  ·  
      7    <lambda>(∂ₓ(x0·x1^2))     2.97703e+00  ·  
      8    <lambda>(∂ₓ(x1^3))       -2.59883e-01  ·  
      9    <lambda>(∂ₓ(x0^4))        5.13787e-01  ·  
      10   <lambda>(∂ₓ(x0^3·x1))    -1.07750e+00  ·  
      11   <lambda>(∂ₓ(x0^2·x1^2))   2.01341e+00  ·  
      12   <lambda>(∂ₓ(x0·x1^3))    -7.65019e-01  ·  
      13   <lambda>(∂ₓ(x1^4))       -8.45582e-01  ·  
      14   <lambda>(∂ₓ(x0^5))        2.15710e-01  ·  
      15   <lambda>(∂ₓ(x0^4·x1))    -8.77543e-01  ·  
      16   <lambda>(∂ₓ(x0^3·x1^2))   3.07597e-01  ·  
      17   <lambda>(∂ₓ(x0^2·x1^3))  -1.72996e+00  ·  
      18   <lambda>(∂ₓ(x0·x1^4))    -1.19158e+00  ·  
      19   <lambda>(∂ₓ(x1^5))        3.59285e-01  ·  
      20   <lambda>(∂ₓ(x0^6))        4.79046e-02  ·  
      21   <lambda>(∂ₓ(x0^5·x1))    -7.02264e-02  ·  
      22   <lambda>(∂ₓ(x0^4·x1^2))   2.57052e-01  ·  
      23   <lambda>(∂ₓ(x0^3·x1^3))   1.92974e-01  ·  
      24   <lambda>(∂ₓ(x0^2·x1^4))   5.24832e-01  ·  
      25   <lambda>(∂ₓ(x0·x1^5))     4.72726e-01  ·  
      26   <lambda>(∂ₓ(x1^6))       -7.43316e-03  ·  
      ────────────────────────────────────────────────────────
      27/27 basis functions in support
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    MLP architecture: 2 → 32 → 32 → 1 (scalar U)   (1184 parameters)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
      ...
      --- StochasticForceInference Report --- 
    Average diffusion tensor:
     [[ 0.48740944 -0.00604295]
     [-0.00604295  0.5008377 ]]
    Measurement noise tensor:
     [[1.7588618e-04 2.3142933e-05]
     [2.3142933e-05 3.1143275e-06]]
    Normalized MSE (force):     0.1406
    Normalized MSE (diffusion): 0.0005
      ...
      28    b28    -1.00774e+00  ·  
                        ...                  
      1155  b1155   1.44580e+00  ·  
      1156  b1156  -3.18246e-01  ·  
      1157  b1157   1.83382e+00  ·  
      1158  b1158  -4.68314e-01  ·  
      1159  b1159  -7.18116e-01  ·  
      1160  b1160   9.47730e-01  ·  
      1161  b1161   9.85791e-01  ·  
      1162  b1162   1.00983e+00  ·  
      1163  b1163   1.48505e+00  ·  
      1164  b1164  -1.51771e+00  ·  
      1165  b1165  -1.56691e-01  ·  
      1166  b1166   6.51398e-02  ·  
      1167  b1167   9.68575e-01  ·  
      1168  b1168  -1.12787e-01  ·  
      1169  b1169  -8.86921e-02  ·  
      1170  b1170   7.35450e-01  ·  
      1171  b1171  -5.74603e-01  ·  
      1172  b1172  -1.68082e-01  ·  
      1173  b1173   1.76319e+00  ·  
      1174  b1174   1.09448e+00  ·  
      1175  b1175  -3.33319e-01  ·  
      1176  b1176  -8.27427e-02  ·  
      1177  b1177   9.18589e-01  ·  
      1178  b1178   5.69197e-01  ·  
      1179  b1179   5.69113e-01  ·  
      1180  b1180   5.07472e-01  ·  
      1181  b1181   1.03056e+00  ·  
      1182  b1182  -5.94096e-01  ·  
      1183  b1183   2.62390e-01  ·  
      ───────────────────────────────────────
      1184/1184 basis functions in support
    L-BFGS IRLS: 2 outer steps, best loss = -54818.4
...
.. GENERATED FROM PYTHON SOURCE LINES 336-367
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
      ...
      --- StochasticForceInference Report --- 
    Average diffusion tensor:
     [[ 0.5059268  -0.00351347]
     [-0.00351347  0.5027457 ]]
    Measurement noise tensor:
     [[0. 0.]
     [0. 0.]]
    Normalized MSE (force):     0.1508
    Normalized MSE (diffusion): 0.0001
      ...
      33   b33    -8.78425e-01  ·  
      ──────────────────────────────────────
      34/34 basis functions in support
...
.. GENERATED FROM PYTHON SOURCE LINES 375-409
...
.. image-sg:: /gallery/advanced/images/sphx_glr_nn_force_demo_002.png
   :alt: Force field comparison — Müller-Brown potential, True force, Polynomial potential (deg 6) NMSE = 1.278, Neural-network potential NMSE = 0.141
...
.. GENERATED FROM PYTHON SOURCE LINES 419-446
...
.. image-sg:: /gallery/advanced/images/sphx_glr_nn_force_demo_003.png
   :alt: Inferred energy landscapes, True potential, Polynomial potential (deg 6), Neural-network potential
...
.. GENERATED FROM PYTHON SOURCE LINES 456-476
...
.. image-sg:: /gallery/advanced/images/sphx_glr_nn_force_demo_004.png
   :alt: |F_inferred − F_true|:  Polynomial (deg 6), |F_inferred − F_true|:  Neural network
   :srcset: /gallery/advanced/images/sphx_glr_nn_force_demo_004.png
   :class: sphx-glr-single-img
...
.. GENERATED FROM PYTHON SOURCE LINES 477-486
...
.. GENERATED FROM PYTHON SOURCE LINES 486-505
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
      ...
      ─────────────────────────────────────────────────────
               Poly (deg 6)        27       1.278         —
      Poly + Parametric SFI        27       1.546        29
                   NN (MLP)        34      0.1508         —
...
.. image-sg:: /gallery/advanced/images/sphx_glr_nn_force_demo_005.png
   :alt: Poly (deg 6), Neural network
   :srcset: /gallery/advanced/images/sphx_glr_nn_force_demo_005.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (3 minutes 1.608 seconds)


.. rst-class:: sphx-glr-example-tags

   🏷 Tags: synthetic, overdamped, nonlinear, neural-network, thermodynamics, 2D
