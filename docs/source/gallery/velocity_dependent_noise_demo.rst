...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Normalized MSE (diffusion): 0.0006
...
.. image-sg:: /gallery/images/sphx_glr_velocity_dependent_noise_demo_003.png
   :alt: velocity dependent noise demo
   :srcset: /gallery/images/sphx_glr_velocity_dependent_noise_demo_003.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 21.718 seconds)


.. rst-class:: sphx-glr-example-tags

   🏷 Tags: synthetic, underdamped, multiplicative-noise, 1D
