...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_abp_to_spde_demo.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_abp_to_spde_demo.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 94-140
...
.. GENERATED FROM PYTHON SOURCE LINES 179-286
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Building initial neighbor list ...
      nnz = 1554306,  ⟨neighbors⟩ = 155.4  (0.20s)
    Loaded cached microscopic trajectory: (1500, 10000, 3) (from abp_to_spde_N10000_L64_S1500_dt0.05_seed7.npy)
    Recorded 1500 frames at Δt = 0.50
    Banded window: frames [300:900]  →  600 frames
    Banding diagnostic on window: ⟨σ_ρ/μ_ρ⟩ = 0.306  (>0.3 ⇒ banded);  polar order ⟨φ⟩ = 0.900
...
.. image-sg:: /gallery/images/sphx_glr_abp_to_spde_demo_001.png
   :alt: Microscopic flock — 10 000 self-propelled particles (colour = heading angle), t = 150.0, t = 300.0, t = 449.5
   :srcset: /gallery/images/sphx_glr_abp_to_spde_demo_001.png
...
.. video:: /gallery/images/sphx_glr_abp_to_spde_demo_002.mp4
   :class: sphx-glr-single-img
   :height: 780
   :width: 810
   :autoplay:
...
.. GENERATED FROM PYTHON SOURCE LINES 346-377
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Coarse-graining: (600, 4096, 3) in 2.0s
    ∫ρ dA = 10000.0  (expected 10000)
    Field trajectory: (600, 4096, 3)
...
.. image-sg:: /gallery/images/sphx_glr_abp_to_spde_demo_003.png
   :alt: Coarse-grained fields:  ρ (colour) + m (streamlines), frame 0, frame 300, frame 599
   :srcset: /gallery/images/sphx_glr_abp_to_spde_demo_003.png
   :class: sphx-glr-single-img
...
.. GENERATED FROM PYTHON SOURCE LINES 415-469
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Overcomplete basis: 20 candidate features (9 for ρ + 11 for m)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Average diffusion tensor:
     [[ 1.7269813e-05  6.2673080e-06 -1.4041916e-05]
     [ 6.2673080e-06  4.1185002e-04  1.4832322e-04]
     [-1.4041916e-05  1.4832322e-04  1.3275006e-04]]
    Measurement noise tensor:
     [[-2.8831907e-06 -8.2338357e-07  9.7881082e-07]
     [-8.2338369e-07  2.5146157e-05  1.8341721e-05]
     [ 9.7881082e-07  1.8341721e-05 -1.5236627e-05]]
    Force estimated information: 684290.3125
    Force: estimated normalized mean squared error (sampling only): 1.4613569012135748e-05

      Force Coefficient Table
      ─────────────────────────────────────────────────────────────────
      #    Label      Coefficient       Std.Err     SNR  Sig
      ─────────────────────────────────────────────────────────────────
      0    ∇·m       -6.42026e-02   2.15407e-04   298.1  ***
      1    ∇·(ρm)     8.27530e-03   9.87390e-05    83.8  ** 
      2    ∇²rho      6.85043e-02   8.50566e-04    80.5  ** 
      3    ∇²ρ²       4.55006e-02   2.37074e-04   191.9  ***
      4    ∇²|m|²    -2.23570e-03   1.50703e-04    14.8  ** 
      5    (m·∇)rho  -1.19461e-02   1.16922e-04   102.2  ***
      6    ρ          1.30153e-03   1.75887e-05    74.0  ** 
      7    ρ²        -3.03218e-05   8.01770e-06     3.8  *  
      8    |m|²      -4.79972e-04   1.16139e-05    41.3  ** 
      9    m          3.65620e-03   6.22864e-05    58.7  ** 
      10   |m|²m     -4.71209e-04   1.20343e-05    39.2  ** 
      11   |m|⁴m      3.54635e-05   9.29253e-07    38.2  ** 
      12   ∇²m        3.24034e-01   7.49543e-04   432.3  ***
      13   ∇(∇·m)    -2.26157e-01   1.15357e-03   196.1  ***
      14   ∇ρ        -8.33872e-02   7.32461e-04   113.8  ***
      15   ∇ρ²        9.73189e-03   1.14047e-04    85.3  ** 
      16   ∇|m|²     -2.23048e-02   1.29393e-04   172.4  ***
      17   (m·∇)m     4.63086e-02   9.44763e-05   490.2  ***
      18   m(∇·m)    -3.17987e-03   1.03356e-04    30.8  ** 
      19   ρm        -5.32718e-04   4.02552e-05    13.2  ** 
      ─────────────────────────────────────────────────────────────────
      20/20 basis functions in support, sig: 20* / 19** / 8*** (|SNR| ≥ 2 / 10 / 100)
      (Std.err. reflects sampling error only; discretization bias is not included.)




.. GENERATED FROM PYTHON SOURCE LINES 489-500
...
.. GENERATED FROM PYTHON SOURCE LINES 500-523
...
.. image-sg:: /gallery/images/sphx_glr_abp_to_spde_demo_004.png
   :alt: Inferred SPDE — coefficients sorted by magnitude  (PASTIS keeps 20/20)
   :srcset: /gallery/images/sphx_glr_abp_to_spde_demo_004.png
   :class: sphx-glr-single-img
...
.. GENERATED FROM PYTHON SOURCE LINES 531-539
...
.. image-sg:: /gallery/images/sphx_glr_abp_to_spde_demo_005.png
   :alt: Bootstrap test — inferred SPDE reproduces the agent-based flock, Agent-based  (coarse-grained), Inferred SPDE  (PASTIS-sparse)
   :srcset: /gallery/images/sphx_glr_abp_to_spde_demo_005.png
   :class: sphx-glr-single-img
...
.. video:: /gallery/images/sphx_glr_abp_to_spde_demo_006.mp4
   :class: sphx-glr-single-img
   :height: 675
   :width: 1350
   :autoplay:
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (6 minutes 15.299 seconds)


.. rst-class:: sphx-glr-example-tags

   🏷 Tags: synthetic, overdamped, multi-particle, linear, SPDE, sparsity


.. _sphx_glr_download_gallery_abp_to_spde_demo.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: abp_to_spde_demo.ipynb <abp_to_spde_demo.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: abp_to_spde_demo.py <abp_to_spde_demo.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: abp_to_spde_demo.zip <abp_to_spde_demo.zip>`
