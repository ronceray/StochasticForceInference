...
# sphinx_gallery_tags = ["synthetic", "overdamped", "SPDE", "reaction-diffusion", "2D", "sparsity", "multi-experiment"]
...
plot_spde_snapshot(coll, coll.T - 1, scalar_channel=0, grid_shape=GRID,
                   cmap="viridis", vmin=0, vmax=1, axes=[ax_t])
plt.show()
# sphinx_gallery_end_ignore
