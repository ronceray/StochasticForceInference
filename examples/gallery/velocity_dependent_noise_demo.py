...
synthetic · underdamped · multiplicative-noise · 1D
"""

# sphinx_gallery_tags = ["synthetic", "underdamped", "multiplicative-noise", "1D"]
...
phase2d_scalar(
    coll_xv,
    color_fn=lambda M: D0 * (1 + (M[:, 1] / vc) ** 2),
    dims=(0, 1), cmap="plasma", plot_colorbar=False, ax=ax_t,
)
