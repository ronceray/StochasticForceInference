...
synthetic · overdamped · multi-particle · linear · interactions
"""

# sphinx_gallery_start_ignore
# sphinx_gallery_tags = ["synthetic", "overdamped", "multi-particle", "linear", "interactions"]
...
plot_particles(coll, t_index=-1, color_dim=2, quiver=True, heading_dim=2,
               box=(Lx, Ly), vmin=-np.pi, vmax=np.pi, s=80, ax=ax_t)
plt.tight_layout()
plt.show()
# sphinx_gallery_end_ignore
